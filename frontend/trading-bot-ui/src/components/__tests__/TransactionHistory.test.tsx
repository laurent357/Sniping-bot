...
describe('TransactionHistory Component', () => {
    ...
    it('opens explorer link in new tab', () => {
        ...
        expect(mockOpen).toHaveBeenCalledWith(
            `https://solscan.io/tx/${mockTrade.id}`,
            '_blank'
        );
    });
    ...
    it('formats timestamps correctly', () => {
        ...
        const timeCell = screen.getByText('10:30:00 AM').parentElement;
        expect(timeCell).toHaveAttribute('title', 'Jan 20, 2024, 10:30:00 AM');
    });
